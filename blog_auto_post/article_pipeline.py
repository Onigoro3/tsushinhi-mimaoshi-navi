...
class ArticlePipeline:
    ...
    def generate_outline(self, topic_title: str, category: str, plans_text: str) -> str:
        system = (
            ...
            "airalo・Sailyといった主要eSIMサービスの料金・データ容量・利用可能日数を"
...
"""
    ...
    def generate_body(
        ...
        system = (
            ...
            "また、プランデータの『信頼度: 低』と明記されたサービス(Saily等)について"
...
"""
    ...
    def self_review(
        ...
        system = (
            ...
            "2) 信頼度lowと明記されたサービス(Saily等)について、断定的すぎる言い切りに"
...
出力要件:
- 見出しは## から始めるMarkdown形式のみ
- 特定サービス(airalo・Saily等)の価格・データ容量等の具体的な数値には
